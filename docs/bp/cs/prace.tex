...
Odkaz k~videonávodu pre~zákazníkov: \url{https://youtube.com/playlist?list=PLOOA_udjNNG0LDXxXWlPfzJYYYjZZh74U}.

\section{Videonávod pre administrátorov}
\label{videonavod pre administratorov}

Odkaz k~videonávodu pre~administrátorov: \url{https://youtube.com/playlist?list=PLOOA_udjNNG3960FNXB_eqGohI9mMkojy}.
