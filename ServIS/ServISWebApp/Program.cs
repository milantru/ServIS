...
internal class Program
{
	...
	private static async Task Main(string[] args)
	{
		...
		using (var scope = app.Services.CreateScope())
		{
			...
			var api = scope.ServiceProvider.GetRequiredService<IServISApi>();
			var admin = await api.GetUserAsync("admin");
			if (admin == null)
			{
				await api.SaveUserAsync(new User
				{
					Username = builder.Configuration["Administrator:Username"]!,
					Password = PasswordHasher.Hash(builder.Configuration["Administrator:Password"]!),
					Role = "Administrator",
			...
			// Store autogenerated messages in the database if they don't exist yet
			var factory = scope.ServiceProvider.GetRequiredService<IDbContextFactory<ServISDbContext>>();
